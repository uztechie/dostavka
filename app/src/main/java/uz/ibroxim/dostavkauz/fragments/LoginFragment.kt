...
//        findNavController().navigate(LoginFragmentDirections.actionLoginFragmentToRegisterFragment("232323"))
        ...
        login_btn_login.setOnClickListener {
            ...
            if (code.length<=5){
                Utils.toastIconError(requireActivity(), getString(R.string.iltimos_tasdiqlash_kodini_toliq_kiriting))
                return@setOnClickListener
            }
            customProgressDialog.show()
...
//                signInWithPhoneAuthCredential(credential)
            ...
            .addOnCompleteListener(requireActivity()) { task ->
                if (task.isSuccessful) {
                    ...
                    if (task.exception is FirebaseAuthInvalidCredentialsException) {
                        ...
                        Utils.toastIconError(requireActivity(), getString(R.string.siz_kiritgan_kod_xato))
                    }
                }
            }
    }
                ...
                is Resource.Success->{
                    ...
                    it.data?.let { login->
                        if (login.status == 200){
                            ...
                            findNavController().navigate(LoginFragmentDirections.actionLoginFragmentToRegisterFragment(phone))
                        }
                        else{
    ...
    private fun stepCodeInputVisibility(){
        ...
        login_tv_description.text = "${getString(R.string.tasdiqlash_kodi_ushbu_raqamga_yuborildi)} \n$phone"
