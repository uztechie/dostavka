...
@AndroidEntryPoint
class NewOrderDetailsFragment : Fragment(R.layout.fragment_new_order_details) {
    private val TAG = "NewOrderDetailsFragment"
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        arguments?.let {
            ...
            new_order_details_tv_latlon.text = latLon
        }
        ...
        new_order_details_map.map.move(
        ...
        new_order_details_btn_call.setOnClickListener {
        ...
        new_order_details_btn_map.setOnClickListener {
            openMap()
        }

        new_order_details_btn_accept.setOnClickListener {
            order?.id?.let {
                viewModel.updateOrderStatus(StatusList.Accepted.id, it)
            }
        }

        new_order_details_btn_cancel.setOnClickListener {
            successFailedDialogForDeleteRequest.show()
            successFailedDialogForDeleteRequest.setStatusImage(R.drawable.question)
            successFailedDialogForDeleteRequest.setTitle(getString(R.string.buyurtmani_ochirish))
            successFailedDialogForDeleteRequest.setMessage(getString(R.string.siz_rostdan_buyurtmani_ochirmoqchimisiz))
            successFailedDialogForDeleteRequest.setButton1Text(getString(R.string.o_chirish))
            successFailedDialogForDeleteRequest.showCloseButton(true)
            successFailedDialogForDeleteRequest.setClickAction(SuccessFailedDialog.ACTION_SUCCESS)
        }
    ...
    private fun drawLocationMark(lat: Double, lon: Double) {
        ...
        new_order_details_map.map.mapObjects.addPlacemark(
            Point(lat, lon),
            ViewProvider(view)
        )
    }
